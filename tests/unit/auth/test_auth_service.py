...
async def test_get_google_redirect_url_success(auth_service: AuthService, settings: Settings):
...
async def test_get_yandex_redirect_url_success(auth_service: AuthService, settings: Settings):
...
async def test_yandex_auth_success(auth_service: AuthService):
    user = await auth_service.google_auth(code="fake_code")
    decoded_user_id = auth_service.get_user_id_from_access_token(access_token=user.access_token)
